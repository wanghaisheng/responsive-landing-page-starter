...
![a text message generated by the application when the memory usage exceeds 80%](/content/blog/send-sms-notifications-on-application-performance-using-c/sms.png)
