...
The only way out is to quickly build a Python website and send a text message to someone. Luckily, you’re a coder and have recently been tinkering with the new FastAPI web framework. You’ve also been trying out the Vonage Messages API to send SMS messages. 
