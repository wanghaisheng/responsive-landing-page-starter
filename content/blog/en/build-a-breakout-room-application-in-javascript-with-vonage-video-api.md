...
uses signaling API to implement breakout room management
re-uses the Publisher object when switching back and forth among rooms
...
For example, 
signaling message with below type and data is to inform application users of new breakout rooms being created and they can choose one to join: 
...
Take a look at the code for more details and hopefully, you find this insightful for your breakout room application.